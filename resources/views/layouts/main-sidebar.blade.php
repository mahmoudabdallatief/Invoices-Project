			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset('assets/img/svgicons/accountant.svg')}}"><span class="avatar-status profile-status bg-green"></span>
						</div>
						<div class="user-info">
...
@endcan
					...
					@can('الفواتير')
						...
						@can('قائمة الفواتير')
							...
							@endcan
							@can('ارشيف الفواتير')
							<li><a class="slide-item" href="{{ route('archive') }}">أرشيف الفواتير</a></li>
							@endcan
						</ul>
					</li>
					@can('التقارير')
